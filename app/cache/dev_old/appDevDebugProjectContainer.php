...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $c = new \Assetic\Cache\ConfigCache('C:/wamp/www/Symfony/app/cache/dev/assetic/config');
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($b, '', 'C:/wamp/www/Symfony/app/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($b, '', 'C:/wamp/www/Symfony/app/Resources/views', '/\\.[^.]+\\.php$/'), 'php');
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $d->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => 'C:\\wamp\\www\\Symfony\\src\\Echyzen\\NewsBundle\\Entity')), 'Echyzen\\NewsBundle\\Entity');

        $e = new \Doctrine\ORM\Configuration();
        $e->setEntityNamespaces(array('EchyzenNewsBundle' => 'Echyzen\\NewsBundle\\Entity'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('C:\\wamp\\www\\Symfony\\src\\Sdz\\BlogBundle/Resources/views', 'SdzBlog');
        $instance->addPath('C:\\wamp\\www\\Symfony\\src\\Echyzen\\NewsBundle/Resources/views', 'EchyzenNews');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'EchyzenNewsBundle' => 'Echyzen\\NewsBundle\\EchyzenNewsBundle',
            ...
            'assetic.java.bin' => 'C:\\Program Files (x86)\\Java\\jdk1.7.0_51\\bin\\java.EXE',
